...
func newCppWabeiGenesisSpec(network string, genesis *core.Genesis) (*cppWabeiGenesisSpec, error) {
	...
	spec.Params.BlockReward = (*hexutil.Big)(wabash.FrontierBlockReward)
...
func newParityChainSpec(network string, genesis *core.Genesis, bootnodes []string) (*parityChainSpec, error) {
	...
	spec.Engine.Wabash.Params.MinimumDifficulty = (*hexutil.Big)(params.MinimumDifficulty)
	spec.Engine.Wabash.Params.DifficultyBoundDivisor = (*hexutil.Big)(params.DifficultyBoundDivisor)
	spec.Engine.Wabash.Params.DurationLimit = (*hexutil.Big)(params.DurationLimit)
	spec.Engine.Wabash.Params.BlockReward = (*hexutil.Big)(wabash.FrontierBlockReward)
	spec.Engine.Wabash.Params.HomesteadTransition = genesis.Config.HomesteadBlock.Uint64()
	spec.Engine.Wabash.Params.EIP150Transition = genesis.Config.EIP150Block.Uint64()
	spec.Engine.Wabash.Params.EIP160Transition = genesis.Config.EIP155Block.Uint64()
	spec.Engine.Wabash.Params.EIP161abcTransition = genesis.Config.EIP158Block.Uint64()
	spec.Engine.Wabash.Params.EIP161dTransition = genesis.Config.EIP158Block.Uint64()
	spec.Engine.Wabash.Params.EIP649Reward = (*hexutil.Big)(wabash.ByzantiumBlockReward)
	spec.Engine.Wabash.Params.EIP100bTransition = genesis.Config.ByzantiumBlock.Uint64()
	spec.Engine.Wabash.Params.EIP649Transition = genesis.Config.ByzantiumBlock.Uint64()
