...
// stateObject represents an Wabei account which is being modified.
//
...
type stateObject struct {
	...
	addrHash common.Hash // hash of wabei address of the account
	data     Account
	db       *StateDB
...
// Account is the Wabei consensus representation of accounts.
