...
// Package accounts implements high level Wabei account management.
package accounts
...
// Account represents an Wabei account located at a specific location defined
// by the optional URL field.
type Account struct {
	Address common.Address `json:"address"` // Wabei account address derived from the key
...
type Wallet interface {
	...
	// chain state reader.
	SelfDerive(base DerivationPath, chain wabei.ChainStateReader)
