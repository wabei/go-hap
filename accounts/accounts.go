...
// Package accounts implements high level Hap account management.
package accounts
...
// Account represents an Hap account located at a specific location defined
// by the optional URL field.
type Account struct {
	Address common.Address `json:"address"` // Hap account address derived from the key
