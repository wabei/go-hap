...
// Package bind generates Wabei contract Go bindings.
//
// Detailed usage document and tutorial available on the go-wabei Wiki page:
// https://github.com/wabei/go-wabei/wiki/Native-DApps:-Go-bindings-to-Wabei-contracts
package bind
