...
// Package bind generates Hap contract Go bindings.
//
// Detailed usage document and tutorial available on the go-hap Wiki page:
// https://github.com/wabei/go-hap/wiki/Native-DApps:-Go-bindings-to-Hap-contracts
package bind
